...
const translations = {
    en: {
        ...
        submit: "Check In",
        generateTipButton: "✨ Daily Tip ✨", // New text for Gemini API button (Not used in this version, but kept for consistency)
        ...
        adhkarError: "Could not load Adhkar. Please try again later.", // Error message for Adhkar
        generatingTip: "✨ Generating a tip for you...", // Loading message for Gemini API (Not used in this version, but kept for consistency)
        tipError: "❌ Could not generate tip. Please try again later.", // Error message for Gemini API (Not used in this version, but kept for consistency)
    ...
    ar: {
        ...
        submit: "تسجيل الحضور",
        generateTipButton: "✨ نصيحة اليوم ✨", // New text for Gemini API button (Not used in this version, but kept for consistency)
        ...
        adhkarError: "لم نتمكن من تحميل الأذكار. يرجى المحاولة لاحقاً.", // Error message for Adhkar
        generatingTip: "✨ جاري توليد نصيحة لك...", // Loading message for Gemini API (Not used in this version, but kept for consistency)
        tipError: "❌ لم نتمكن من توليد النصيحة. يرجى المحاولة لاحقاً.", // Error message for Gemini API (Not used in this version, but kept for consistency)
